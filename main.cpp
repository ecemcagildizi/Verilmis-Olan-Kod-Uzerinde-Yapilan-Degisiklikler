...
int diziBolme(int a[], int ilk, int son, int pivot);
void quickSort(int a[], int ilk, int son);
...
void quickSort(int a[], int ilk, int son){
	if(ilk < son) {
	    int pivot = a[son];
	    int pivotIndex = diziBolme(a, ilk, son, pivot);
            quickSort(a, ilk, pivotIndex-1);
            quickSort(a, pivotIndex+1, son);
	}
}
